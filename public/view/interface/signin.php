                ...
                <div class="sig-input-area gap-4 w-100 px-5">
                    <form action="/" method="post"> 
                            <div class="alg-text-primary fw-bold px-4">
                                    ...
                                    <input type="email" class="alg-input" id="Email" placeholder="Enter your account email..." required>
                            </div>
                            <br>
                            <div class="alg-text-primary fw-bold px-4">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center ">
                        <p class="mt-3 alg-text-light-50">Don’t have an account?  <a href="/register" class="alg-text-primary-dark">Register</a></p>
                        <div class="sig-line-main alg-text-light-75">
                            <div class="sig-line alg-bg-light-75"></div>
                            <span class="px-4">OR</span>
                            <div class="sig-line alg-bg-light-75"></div>
                        </div>
                        <br>
                        <p class="alg-text-light-50">Request Admin Access: <a href="/" class="alg-text-primary-dark">Here</a></p>      
                    </div> 
                </div>
            </div>
        </div>
